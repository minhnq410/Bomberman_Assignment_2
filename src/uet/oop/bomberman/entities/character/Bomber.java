...
public class Bomber extends Character
{
	...
	public void render(Screen screen)
	{
		...
		if (_alive)
			chooseSprite();
		else _sprite = Sprite.player_dead1;
	...
	private void clearBombs()
	{
		...
		while (bs.hasNext())
		{
			...
			if (b.isRemoved())
			{
				bs.remove();
				Game.addBombRate(1);
				if (_board.getEntityAt(b.getX(), b.getY()) instanceof LayeredEntity)
				{
					LayeredEntity tmp = (LayeredEntity) _board.getEntityAt(b.getX(), b.getY());
					if (tmp.getTopEntity() instanceof Portal)
					{
						_board.addEntity((int) (b.getX() + b.getY() * _board.getLevel().getWidth()),
								new LayeredEntity((int) b.getX(), (int) b.getY(), new Grass((int) b.getX(), (int) b.getY(), Sprite.grass), new Portal((int) b.getX(), (int) b.getY(), Sprite.portal, _board)));
					}
				}
				else
				{
					_board.addEntity((int) (b.getX() + b.getY() * _board.getLevel().getWidth()),
						new Grass((int) b.getX(), (int) b.getY(), Sprite.grass));
				}
			}
		}
